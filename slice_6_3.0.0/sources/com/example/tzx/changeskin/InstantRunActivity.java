...
public class InstantRunActivity extends Activity {
    ...
    public static final long serialVersionUID = 8155266132880023579L;
    private Button button;
    private InstantRunActivity context;
    private int num;
    ...
    InstantRunActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            ...
            case 1237721170:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/tzx/changeskin/InstantRunActivity"}));
        }
    }

    public static /* synthetic */ int access$008(InstantRunActivity x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Number) incrementalChange.access$dispatch("access$008.(Lcom/example/tzx/changeskin/InstantRunActivity;)I", new Object[]{x0})).intValue();
        }
        int i = x0.num;
        x0.num = i + 1;
        return i;
    ...
    public static /* synthetic */ void access$100(InstantRunActivity x0, Object x1) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("access$100.(Lcom/example/tzx/changeskin/InstantRunActivity;Ljava/lang/Object;)V", new Object[]{x0, x1});
            return;
        }
        x0.change(x1);
    }
    ...
    public static /* synthetic */ Object access$super(InstantRunActivity instantRunActivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/tzx/changeskin/InstantRunActivity"}));
        }
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.button.setOnClickListener(new OnClickListener(this) {
            public static volatile transient /* synthetic */ IncrementalChange $change = null;
            public static final long serialVersionUID = 6524170362109919476L;
            public final /* synthetic */ InstantRunActivity this$0;
            ...
            AnonymousClass1(Object[] objArr, InstantReloadException instantReloadException) {
                switch (((String) objArr[1]).hashCode()) {
                    ...
                    case 666184023:
                        ...
                        return;
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/tzx/changeskin/InstantRunActivity$1"}));
                }
            }
            ...
            public static /* synthetic */ Object access$super(AnonymousClass1 anonymousClass1, String str, Object... objArr) {
                switch (str.hashCode()) {
                    ...
                    case 2025021518:
                        return super.clone();
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/tzx/changeskin/InstantRunActivity$1"}));
                }
            }
            ...
            public void onClick(View v) {
                ...
                Log.d("tanzhenxing", "-" + (InstantRunActivity.access$008(this.this$0) * 2) + 1);
                InstantRunActivity.access$100(this.this$0, this);
            }

            {
                ...
                this.this$0 = this$0;
                if (incrementalChange != null) {
                    Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/tzx/changeskin/InstantRunActivity$1;Lcom/example/tzx/changeskin/InstantRunActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, new Object[0]});
                    Object[] objArr2 = (Object[]) objArr[0];
                    /* anonymous class already generated */;
                    objArr2[0] = this;
                    incrementalChange.access$dispatch("init$body.(Lcom/example/tzx/changeskin/InstantRunActivity$1;Lcom/example/tzx/changeskin/InstantRunActivity;[Ljava/lang/Object;)V", objArr2);
                }
            }
        });
        this.button.setBackgroundResource(R.color.defalut);
        Log.d("tanzhenxing-application", getApplication().getClass().getSimpleName());
    }

    public InstantRunActivity() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/tzx/changeskin/InstantRunActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/tzx/changeskin/InstantRunActivity;[Ljava/lang/Object;)V", objArr2);
        }
    }

    private void change(Object obj) {
        Class clazz = obj.getClass();
        Log.d("tanzhenxing", clazz.getClassLoader().getClass().getSimpleName());
        try {
            for (Field field : clazz.getDeclaredFields()) {
                field.setAccessible(true);
                Log.d("tanzhenxing00", field.getName());
                Object changeValue = field.get(obj);
                if (changeValue != null) {
                    Class changeClass = changeValue.getClass();
                    Log.d("tanzhenxing", changeClass.getClassLoader().getClass().getSimpleName());
                    if (changeClass.getClassLoader().getParent() != null) {
                        Log.d("tanzhenxing-parent", changeClass.getClassLoader().getParent().getClass().getSimpleName());
                    }
                    Log.d("tanzhenxing-", changeClass.getSimpleName());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
