...
public class MyApplication extends Application {
    ...
    public static final long serialVersionUID = 8421544907082243964L;

    MyApplication(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            ...
            case 1159590441:
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/tzx/changeskin/MyApplication"}));
        }
    }

    public static /* synthetic */ Object access$super(MyApplication myApplication, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2128160755:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/tzx/changeskin/MyApplication"}));
        }
    }
    ...
    public void onCreate() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("onCreate.()V", new Object[]{this});
            return;
        }
        super.onCreate();
    }
    ...
    public MyApplication() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/tzx/changeskin/MyApplication;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/tzx/changeskin/MyApplication;[Ljava/lang/Object;)V", objArr2);
        }
    }
}
