...
public class MainActivity extends Activity {
    ...
    public static final long serialVersionUID = -7648216017847793967L;
    private InstantRunUtils instantRunUtils;
    ...
    MainActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            ...
            case -704177599:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/instantrun/MainActivity"}));
        }
    }
    ...
    public static /* synthetic */ Object access$super(MainActivity mainActivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/instantrun/MainActivity"}));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("tanzhenxing", "MainActivity");
        this.instantRunUtils = new InstantRunUtils();
    ...
    public MainActivity() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/instantrun/MainActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/instantrun/MainActivity;[Ljava/lang/Object;)V", objArr2);
        }
    }
}
