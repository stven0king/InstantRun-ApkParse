...
public class MyApplication extends Application {
    ...
    public static final long serialVersionUID = -2834479356355500621L;
    ...
    MyApplication(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            ...
            case 1159590441:
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/instantrun/MyApplication"}));
        }
    }
    ...
    public static /* synthetic */ Object access$super(MyApplication myApplication, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/instantrun/MyApplication"}));
        }
    }
    ...
    public MyApplication() {
        ...
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/instantrun/MyApplication;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/instantrun/MyApplication;[Ljava/lang/Object;)V", objArr2);
        }
    }
}
